...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        #g o to read-me file bottom 
        remote_server_uri = "https://dagshub.com/Bharadwaj6903/DeepCNNClassifier.mlflow "
        mlflow.set_tracking_uri(remote_server_uri)
        #comment the above 2 lines if u wnat to se filemodel
...
python script.py
go with latest vesrion of mlflow
        '''